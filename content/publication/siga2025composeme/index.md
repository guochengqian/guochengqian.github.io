...
abstract_short = "ComposeMe is a human-centric generative model that enables disentangled control over multiple visual attributes — such as identity, hair, and garment — across multiple subjects, while also supporting text-based control. It uses attribute-specific tokenization and multi-attribute cross-reference training to enable state-of-the-art personalized generation with fine-grained and disengtangled attribute control."
