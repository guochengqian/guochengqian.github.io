...
- *2025/09*: Corresponding authored paper [SR-Training](https://snap-research.github.io/shortcut-rerouting/) accepted to NeurIPS 2025. SR-Training was shipped to product pipeline as a training technique. 
- *2025/07*: ComposeMe shipped to Snapchat AI Lens to make personalized generation follow expression prompts. Multi-million human-centric dataset developped in ComposeMe is used in training for all related products.
...
- *2025/05*: Omni-ID shipped to Snapchat production pipeline to support Look Like Me.
- *2025/02*: Three papers accepted to CVPR 2025, including one first-authored paper, [Omni-ID](https://snap-research.github.io/Omni-ID/), and two mentored internship projects, [WonderLand](https://snap-research.github.io/wonderland/) and [AC3D](https://snap-research.github.io/ac3d/).
...
- *2020/01*: Served as a teaching assistant for CS390D Deep Learning (Spring 2020).
- *2018/07*: Graduated from Xi'an Jiaotong University with the highest undergraduate honor (GPA __3.9__/4.3).
